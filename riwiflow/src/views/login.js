// views/login.js — Login screen, matched exactly to the reference design
...
const login = {
  mounted: () => {
    ...
    // Set container to match the requested body classes
    container.className = "bg-surface-container-lowest text-on-surface min-h-screen flex flex-col";
      ...
      <div class="w-full max-w-[440px] space-y-xl">
        ...
        >
          <form class="space-y-lg" id="loginForm" onsubmit="return false;">
            ...
            <!-- Error message (added for functionality, hidden by default) -->
